...
tab3 = ttk.Frame(notebook)  # Only two tabs now

notebook.add(tab1, text="Service 1 (tar1090)")
notebook.add(tab3, text="Service 2 (acarshub)")  # Adjust tab numbering

# Function to manually set the initial focus
def set_initial_focus(event):
    start_button_3.focus_set()

# Bind an event to the second tab to set the initial focus
...
# Create and configure widgets for Service 2 (acarshub)
...
# Load and display the current configuration values for Service 2 (acarshub)
...
# Arrange widgets for Service 2 (acarshub)
